...
contract HealthCare {
  ...
  mapping (address => doctor) public doctors;// doctor and list of patient profile he can access
  mapping (address => mapping(address => uint)) public doctorToPatient;
  mapping (address => patient) public patients;
  mapping (address => mapping (address => uint)) public patientToDoctor;
  mapping (bytes32 => filesInfo) public hashToFile; //filehash to file info
  mapping (address => mapping (bytes32 => uint)) public patientToFile;
  uint public gpos;
